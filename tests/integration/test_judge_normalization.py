...
async def test_judge_normalization_removes_bias(tmp_output_dir):
    ...
    certamen._all_models["harsh"] = harsh_model
    certamen._all_models["generous"] = generous_model
    certamen._healthy_models["harsh"] = harsh_model
...
async def test_judge_normalization_with_extreme_bias(tmp_output_dir):
    ...
    certamen._all_models["super_harsh"] = super_harsh
    certamen._all_models["super_generous"] = super_generous
    certamen._healthy_models["super_harsh"] = super_harsh
    certamen._healthy_models["super_generous"] = super_generous

    result, metrics = await certamen.run_tournament("Test extreme bias")
