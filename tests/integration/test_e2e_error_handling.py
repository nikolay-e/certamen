...
class TestModelFailures:
    ...
    async def test_tournament_continues_with_partially_failed_models(
        ...
        certamen._healthy_models = healthy  # type: ignore[assignment]
        certamen._comparison = certamen._create_comparison()

        result, metrics = await certamen.run_tournament("Test question?")
...
class TestEdgeCases:
    ...
    async def test_single_model_tournament(
        ...
        certamen._healthy_models = {"only_model": mock_model}  # type: ignore[assignment]
        certamen._comparison = certamen._create_comparison()
    ...
    async def test_empty_question_handling(
        ...
        result, _metrics = await certamen.run_tournament("")
    ...
    async def test_very_long_question_handling(
        ...
        result, _metrics = await certamen.run_tournament(long_question)
    ...
    async def test_special_characters_in_question(
        ...
        result, _metrics = await certamen.run_tournament(special_question)
...
class TestCostTracking:
    ...
    async def test_cost_tracked_even_with_failures(
        ...
        _result, metrics = await certamen.run_tournament("Test question?")
