...
from certamen.domain.knowledge.bank import EnhancedKnowledgeBank
from certamen.domain.model_selection import select_model_by_capacity
from certamen.domain.prompts import (
...
from certamen.domain.tournament.history import TournamentHistoryBuilder
...
class TournamentRunner:
    ...
    async def _extract_interrogation_insights(
        ...
        from certamen.shared.constants import INTERROGATION_INSIGHT_PROMPT
        from certamen.shared.text import parse_insight_lines
    ...
    async def _run_disagreement_phase(
        ...
        from certamen.domain.disagreement.resolver import (
    ...
    def _render_knowledge_map_context(self, km: Any) -> str:
        try:
            from certamen.domain.knowledge_map.renderer import (
