"""
Provenance tracking and report generation for Certamen Framework tournaments.
...
class ProvenanceReport:
    ...
    async def save_to_file(
        ...
        Saves 3 files:
        1. certamen_{timestamp}_champion_solution.md - Champion answer + provenance MD
        2. certamen_{timestamp}_provenance.json - Compact provenance metadata
        3. certamen_{timestamp}_complete_history.json - Full tournament history
