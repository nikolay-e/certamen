...
from certamen.interfaces.web.auth.database import query_db
...
DUMMY_HASH_FOR_TIMING_ATTACK_PREVENTION = "$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/X4.5qLB6kGGGGGGGG"  # intentional dummy, not a real credential  # pragma: allowlist secret
