...
from certamen.shared.constants import DEFAULT_LOG_CACHE_SIZE
...
class ColorFormatter(logging.Formatter):
    ...
    def __init__(
        ...
        from certamen.shared.terminal import MODEL_COLORS
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        from certamen.shared.logging.structured import build_context_parts
        ...
        if should_colorize:
            ...
            from certamen.shared.terminal import strip_ansi_codes
    ...
    def _should_use_color(self) -> bool:
        from certamen.shared.terminal import should_use_color
...
def _create_file_handler(
    ...
    try:
        ...
        from certamen.shared.logging.structured import JSONFormatter
...
def setup_logging(
    ...
    from certamen.shared.logging.structured import ContextFilter
