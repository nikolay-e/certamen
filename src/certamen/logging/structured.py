"""Structured logging with correlation IDs and JSON support for Certamen Framework."""
...
class ContextualLogger:
    ...
    Usage:
        logger = ContextualLogger("certamen")
    ...
    def __init__(self, name: str = "certamen"):
...
def get_contextual_logger(name: str = "certamen") -> ContextualLogger:
