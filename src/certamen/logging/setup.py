"""
Structured logging wrapper for Certamen Framework.
...
from certamen.utils.constants import DEFAULT_LOG_CACHE_SIZE
...
class ColorFormatter(logging.Formatter):
    ...
    def __init__(
        ...
        from certamen.utils.display import MODEL_COLORS
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        from certamen.logging.structured import build_context_parts
        ...
        if should_colorize:
            ...
            from certamen.utils.terminal import strip_ansi_codes
    ...
    def _should_use_color(self) -> bool:
        from certamen.utils.terminal import should_use_color
...
def _create_file_handler(
    ...
    try:
        ...
        from certamen.logging.structured import JSONFormatter
...
def setup_logging(
    ...
    if log_file is None and enable_file_logging:
        ...
        log_file = f"certamen_{timestamp}_logs.log"
    ...
    from certamen.logging.structured import ContextFilter
