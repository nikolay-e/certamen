...
2. **Clone** your forked repository:
    ...
    ```sh
    git clone https://github.com/YOUR_USERNAME/certamen-core.git
    cd certamen-core
    ```
...
Use [GitHub Issues](https://github.com/nikolay-e/certamen-core/issues) with the provided templates:
