...
1. Go to the [Security tab](https://github.com/nikolay-e/arbitrium-core/security)
...
- ❌ **Compliance-Heavy Environments:** Not designed for compliance-heavy environments without additional controls
...
- **GitHub Watch:** Click "Watch" → "Releases only" on [our repo](https://github.com/nikolay-e/arbitrium-core)
- **Security Advisories:** [GitHub Security Advisories](https://github.com/nikolay-e/arbitrium-core/security/advisories)

## Questions?

For security-related questions (not vulnerabilities), please:

- Open a [GitHub Discussion](https://github.com/nikolay-e/arbitrium-core/discussions) (preferred)
- Or file a regular [GitHub Issue](https://github.com/nikolay-e/arbitrium-core/issues) with the `security-question` label

For general questions, use [GitHub Discussions](https://github.com/nikolay-e/arbitrium-core/discussions).
